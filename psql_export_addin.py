...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("complementary", name="Clevervue").locator("iframe").content_frame.locator("#sandboxFrame").content_frame.locator("#userHtmlFrame").content_frame.get_by_text("psqlcbt_ex").click(force=True)
