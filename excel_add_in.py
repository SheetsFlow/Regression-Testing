...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("complementary", name="Clevervue").locator("iframe").content_frame.locator("#sandboxFrame").content_frame.locator("#userHtmlFrame").content_frame.locator("//*[@id='index']/div[2]/div[3]/div[2]/div[1]/button[3]").click()
    file_path = os.path.abspath("C:\\Users\\BTCCHL00037.BTCCHL0037\\PycharmProjects\\cross_browser_test_cv\\employees.xlsx")

    page.get_by_role("complementary", name="Clevervue").locator("iframe").content_frame.locator("#sandboxFrame").content_frame.locator("#userHtmlFrame").content_frame.locator("input[type='file'][accept='.xls, .xlsx']").set_input_files(file_path)
    page.get_by_role("complementary", name="Clevervue").locator("iframe").content_frame.locator("#sandboxFrame").content_frame.locator("#userHtmlFrame").content_frame.locator("label").filter(has_text="in").click()
    ...
    page.goto("https://docs.google.com/spreadsheets/d/1H5dWCnF5vMEEVtnoDxKtz4tTdEzQZvz7ybk1OwHom-U/edit?gid=2018617235#gid=2018617235")
